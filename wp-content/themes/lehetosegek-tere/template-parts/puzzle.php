<div id="lt_puzzle" class="relative w-full h-auto transition-opacity duration-500 opacity-0 aspect-square bg-turquoise group">
    ...
    <div class="absolute w-1/3 h-1/3 top-0 left-0 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] cursor-pointer" data-item-number="1" data-rotation="0">
      <div class="flex items-center justify-center w-full h-full text-white">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400">
          ...
          <g data-name="Layer 2">
            <circle cx="200" cy="200" r="200" data-name="Layer 1" style="fill:url(#a)"/>
          </g>
        </svg>
      </div>
    </div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400">
          <defs>
            <linearGradient id="puzzle_square" x1="200" x2="200" y1="400" gradientUnits="userSpaceOnUse">
              ...
              <stop offset="1" stop-color="#f9101e"/>
            </linearGradient>
          </defs>
          <path d="M0 0h400v400H0z" stroke="currentColor" style="fill:url(#puzzle_square)"/>
        </svg>
      </div>
    </div>
    <div class="absolute w-1/3 h-1/3 top-0 left-0 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] cursor-pointer" data-item-number="4" data-rotation="0">
      <div class="flex items-center justify-center w-full h-full text-white">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400">
          ...
          <path d="M0 0v400h400C400 179.09 220.91 0 0 0Z" style="fill:url(#puzzle_slice)"/>
        </svg>
      </div>
    </div>
      ...
      <div class="flex items-center justify-center w-full h-full text-white">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400">
          <defs>
            ...
            <linearGradient id="puzzle_half_cirlce_right_b" x1="300" x2="300" y2="400" gradientUnits="userSpaceOnUse">
              <stop offset="0" stop-color="#eb6b2d"/>
              <stop offset="1" stop-color="#f9101e"/>
            </linearGradient>
          </defs>
          <path d="M0 0c110.46 0 200 89.54 200 200S110.46 400 0 400" style="fill:url(#puzzle_half_cirlce_right_a)"/>
          <path d="M400 400c-110.46 0-200-89.54-200-200S289.54 0 400 0" style="fill:url(#puzzle_half_cirlce_right_b)"/>
        </svg>
      </div>
    </div>
    <div class="absolute w-1/3 h-1/3 top-0 left-0 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] cursor-pointer" data-item-number="7" data-rotation="0">
      <div class="flex items-center justify-center w-full h-full text-white">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
          ...
          <path d="M100 50V0H0v100h50a50 50 0 0 1 50-50Z" data-name="Layer 1" style="fill:url(#puzzle_gate_left)"/>
        </svg>
      </div>
    </div>
    <div class="absolute w-1/3 h-1/3 top-0 left-0 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] cursor-pointer" data-item-number="8" data-rotation="0">  
      <div class="flex items-center justify-center w-full h-full text-white">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
          ...
          <g data-name="Layer 2">
            <path d="M0 0v100a100 100 0 0 1 100 100h100V0Z" data-name="Layer 1" style="fill:url(#puzzle_gate_right)"/>
          </g>
        </svg>
      </div>
    </div>
  </div>
  <div id="lt_puzzle_notification" class="z-10 p-4 bg-white absolute-center group-hover:opacity-0 group-hover:hidden">
